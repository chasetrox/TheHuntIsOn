...
public class UIFader : MonoBehaviour
{
    ...
    [SerializeField] bool startVisible = false;                 // Should the UI elements be visible to start?
    [SerializeField] bool startWithFade = false;                // Should the UI elements begin fading with they start up? Fading can either be in or out (opposite of their starting alpha)
